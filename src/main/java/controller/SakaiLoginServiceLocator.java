...
public class SakaiLoginServiceLocator extends org.apache.axis.client.Service implements SakaiLoginService {
    ...
    public SakaiLogin getSakaiLoginPort() throws javax.xml.rpc.ServiceException {
    ...
    public SakaiLogin getSakaiLoginPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            SakaiLoginServiceSoapBindingStub _stub = new SakaiLoginServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (SakaiLogin.class.isAssignableFrom(serviceEndpointInterface)) {
                SakaiLoginServiceSoapBindingStub _stub = new SakaiLoginServiceSoapBindingStub(new java.net.URL(SakaiLoginPort_address), this);
                _stub.setPortName(getSakaiLoginPortWSDDServiceName());
                return _stub;
            }
        }
